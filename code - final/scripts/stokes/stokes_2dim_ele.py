...
steps = 600 # steps in integrals over each element
# as you increase H make sure to increase steps
...
# declaring appropriate forcing functions. Change these to anything you want if you want to test the code
...
for ka, a in enumerate(mat_funcs):
    ...
    for k, ele in enumerate(quad_elements):
        # creating domain for integration
...
# dissassembling solution vector
...
print(f"{H**2} nodes per function")
print(f"u1 error = {error_u1_sol}")
print(f"u2 error = {error_u2_sol}")
print(f"p error = {error_p_sol}")